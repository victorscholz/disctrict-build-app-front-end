...
const buildingUrl = 'https://data.cityofnewyork.us/resource/x3ar-yjn2.json?borough=SI'
  ...
  componentDidMount() {
    ...
    map.on('load', function () {
      ...
      map.addSource('buildings', {
        'type': 'geojson',
        'data':
        'https://data.cityofnewyork.us/resource/x3ar-yjn2.geojson',
        // cluster: true,
      ...
      map.on('click','nycody.bx1az61y', function (e) {
        ...
        .setLngLat(e.lngLat)
        .setHTML(
          '<strong>Developer: </strong>' + e.features[0].properties.own_devel +
          '<br><strong>Build Type: </strong></br>' + e.features[0].properties.build_type +
          '<br><strong>Architect: </strong></br>' + e.features[0].properties.arch_build +
          '<br><strong>Style: </strong></br>' + e.features[0].properties.style_prim +
          '<br><strong>Materials: </strong></br>' + e.features[0].properties.mat_prim + ' & ' + e.features[0].properties.mat_sec +
          '<br><strong>Build Date: </strong></br>' + e.features[0].properties.date_combo +
          '<br><strong>Original Use: </strong></br>' + e.features[0].properties.use_orig +
          // '<br><strong>Secondary Material: </strong></br>' + e.features[0].properties.mat_sec + 
          '<br><strong>Borough: </strong></br>' + e.features[0].properties.borough +
          '<br><strong>Historical District: </strong></br>' + e.features[0].properties.hist_dist +
          '<br><strong>Address: </strong></br>' + e.features[0].properties.des_addres +
          `<br><button class="visit-button" onClick='${this.clickListener}'>Add to visit list</button></br>`
        )
        .addTo(map)
